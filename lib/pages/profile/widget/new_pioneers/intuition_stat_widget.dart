...
class IntuitionStatWidget extends ConsumerStatefulWidget {
  const IntuitionStatWidget({super.key});

  @override
  ConsumerState<IntuitionStatWidget> createState() =>
      _IntuitionStatWidgetState();
}

class _IntuitionStatWidgetState extends ConsumerState<IntuitionStatWidget>
    with AnimationMixin {
      ...
      children: [
        Image(
          ...
          image: const AssetImage(
              'assets/images/profile/newpioneers_intuition.png'),
        ),
        SizedBox(
          height: 7.w,
        ),
            ...
            child: Column(
              ...
              children: [
                ...
                if (newProfileSelected != null)
                  Text(
                    newProfileSelected.stat != null
                        ? newProfileSelected.stat!.intuition.toString()
                        : '-',
                    style: TextStyle(
                      color: Colors.white,
                      height: 1.2,
                ...
                if (newProfileSelected != null)
                  Text(
                    newProfileSelected.statBonus != null
                        ? '(+${newProfileSelected.statBonus!.intuition.toString()})'
                        : '',
                    style: TextStyle(
