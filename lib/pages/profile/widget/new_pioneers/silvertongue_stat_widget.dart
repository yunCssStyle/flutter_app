...
class SilverTongueStatWidget extends ConsumerStatefulWidget {
  const SilverTongueStatWidget({super.key});

  @override
  ConsumerState<SilverTongueStatWidget> createState() =>
      _SilverTongueStatWidgetState();
}

class _SilverTongueStatWidgetState extends ConsumerState<SilverTongueStatWidget>
    with AnimationMixin {
    ...
    return Column(
      ...
      children: [
        Image(
          ...
          fit: BoxFit.fitWidth,
          image:
              const AssetImage('assets/images/profile/newpioneers_tongue.png'),
        ),
        SizedBox(
          height: 7.w,
        ),
            ...
            child: Column(
              ...
              children: [
                ...
                if (newProfileSelected != null)
                  Text(
                    newProfileSelected.stat != null
                        ? newProfileSelected.stat!.silverTongue.toString()
                        : '-',
                    style: TextStyle(
                      color: Colors.white,
                      height: 1.2,
                ...
                if (newProfileSelected != null)
                  Text(
                    newProfileSelected.statBonus != null
                        ? '(+${newProfileSelected.statBonus!.silverTongue.toString()})'
                        : '',
                    style: TextStyle(
