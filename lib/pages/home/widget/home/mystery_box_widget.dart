...
class MysteryBoxBtnWidget extends ConsumerWidget {
  final bool mysteryBox;
          ...
          ? MotionButton(
              ...
              child: FullPage(
                ...
                closedBuilder: (BuildContext _, VoidCallback defenseOpens) {
                  return FullPageOpen(
                    openContainer: () async {
                      ref.read(mysteryboxProvider.notifier).setMysteryboxData();
                      ref.read(homeProvider.notifier).mysteryBoxFalse();
                      defenseOpens();
                    },
                    height: 31.w,
                    child: Center(
                      child: Image.asset(
                        'assets/images/home/box_grade_1.png',
                        width: 90.w,
                        fit: BoxFit.fitWidth,
                      ),
                    ),
