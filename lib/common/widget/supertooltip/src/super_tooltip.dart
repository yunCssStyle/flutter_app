...
import 'package:minewarz_app/common/widget/supertooltip/src/bubble_shape.dart';
...
class SuperTooltip extends StatefulWidget {
  const SuperTooltip({
    ...
    this.backgroundColor = AppColor.lightBule,
    this.decoration,
    this.child,
    ...
    this.arrowBaseWidth = 10.0,
    this.arrowTipDistance = 25.0,
    this.touchThroughAreaShape = ClipAreaShape.oval,
    this.touchThroughAreaCornerRadius = 0.0,
...
class _SuperTooltipState extends State<SuperTooltip>
  ...
  Widget build(BuildContext context) {
    ...
    shadowBlurRadius = widget.shadowBlurRadius ?? 0.0;
    shadowSpreadRadius = widget.shadowSpreadRadius ?? 0.0;
